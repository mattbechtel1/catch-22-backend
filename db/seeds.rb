...
DEFAULT_PARTNERS = [
    ...
    {name: 'Nately', description: "Edward J. Nately III comes from a very wealthy family. He enlisted in the air corps thinking the war would be over shortly and that he would be able to mingle with gentlemen. He is a a capable pilot. He has fallen head-over-heels in love with a whore in Rome, who cannot speak English, but he has plans to marry after the war.", sanityChange: -1, sublist: 'airman', occupation: 'Lieutenant', erraticness: 3},
    {name: 'Dobbs', description: "Dobbs has been at war for a while. His nerves are shot, and his flying is increasingly erratic. He will murder Colonel Cathcart; all you have to do is give him the go-ahead.", sanityChange: -1, erraticness: 8, sublist: 'airman', occupation: 'Pilot'},
