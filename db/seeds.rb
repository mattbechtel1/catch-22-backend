...
DEFAULT_PARTNERS = [
    ...
    {name: 'Colonel Cathcart', image_url: 'https://vignette.wikia.nocookie.net/catch22/images/1/17/Cathcart-profile.jpg', description: 'Colonel Cathcart is the commander of the squadron. He is goal-oriented and wishes to climb the U.S. Army heirarchy. He fears failure.', sanityChange: nil, sublist: 'special', occupation: 'Colonel', erraticness: nil},
